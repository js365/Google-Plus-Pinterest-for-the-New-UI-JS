...
var GooglePlusPlus = (function ($$d) {
	...
	var CSS_DICTIONARY = [
		...
		[/<streamContainer>/g, '<streamContent> .aw'],
	...
	var GPinterest = (function () {
		...
		function _init_CSS() {
			...
			css.set(
				...
				<shareBoxContainer>, <searchFilter>, <matchedPerson>, <myGames>, <gameStream> { \
					margin-left: -52px; \
					position: absolute; \
					margin-top: 20px; \
					z-index: 4; \
				...
				<nothingSharedYet> { \
					margin-top: 100px; \
					margin-left: '+ mainContentLeftMargin +'px; \
				} \
				'
			);
		...
		var layout = (function () {
			...
			return function ($opt) {
				...
				if (moreButtonContainer && maxHeight != height) {
					...
					contentPane.style.minHeight = (height + 200)+'px';
				}
			};
		})();
